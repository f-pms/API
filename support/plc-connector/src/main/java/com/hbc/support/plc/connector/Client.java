/*
 * PROJECT support.plc.connector (fork of Snap7/Moka7)
 *
 ...
 *
 * support.plc.connector is distributed in the hope that it will be useful, but WITHOUT ANY WARRANTY; without even
 * the implied warranty of MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE whatever license you
 * decide to adopt.
 *
 * Contributors: Davide Nardella - initial API and implementation J.Zimmermann - support.plc.connector fork
 *
 */
package com.hbc.support.plc.connector;

import com.hbc.support.plc.connector.block.BlockType;
import com.hbc.support.plc.connector.block.PlcCpuStatus;
import com.hbc.support.plc.connector.block.S7BlockInfo;
import com.hbc.support.plc.connector.block.S7BlockList;
import com.hbc.support.plc.connector.block.S7CpInfo;
import com.hbc.support.plc.connector.block.S7CpuInfo;
import com.hbc.support.plc.connector.block.S7DataItem;
import com.hbc.support.plc.connector.block.S7OrderCode;
import com.hbc.support.plc.connector.block.S7Protection;
import com.hbc.support.plc.connector.block.S7Szl;
