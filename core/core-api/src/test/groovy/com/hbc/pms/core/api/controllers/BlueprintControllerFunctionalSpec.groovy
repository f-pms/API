...
class BlueprintControllerFunctionalSpec extends FunctionalTestSpec {
  ...
  def "Get all blueprints by blueprintType - OK"() {
    ...
    when:
    def response
            = restClient.get("/blueprints?blueprintType=ALARM", ApiResponse<List<BlueprintResponse>>)
  ...
  def "Get all blueprints by blueprintType and blueprintName - OK"() {
    ...
    when:
    def response
            = restClient.get("/blueprints?blueprintType=ALARM&blueprintName=PREDEFINED", ApiResponse<List<BlueprintResponse>>)
  ...
  def "Get all blueprints by blueprintName - Not existed name - OK with empty list"() {
    when:
    def response
            = restClient.get("/blueprints?blueprintName=Random", ApiResponse<List<BlueprintResponse>>)
  ...
  def "Update sensor config - Using address field - OK"() {
    ...
    def response = restClient
            .put(
                    ...
                    updateConfigRequest, ApiResponse<Boolean>)
